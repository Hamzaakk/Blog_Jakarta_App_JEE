...
public class PostDaoImpl implements IPostDao{
    ...
    private void posts(List<Post> posts, PreparedStatement pr) throws SQLException {
        Post p;
        ResultSet rs = pr.executeQuery();
        while (rs.next()){
            p=new Post();
    ...
    public Post AddNewPost(Post post) {
        Connection connection = SingletonConnection.getConnection();
        String query = "INSERT INTO posts (title, image_url, content, created_at) VALUES (?, ?, ?, current_timestamp())";
        try {
